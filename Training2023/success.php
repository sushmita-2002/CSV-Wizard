...
<body>
    <div class="container">
        ...
        if ($result1) {
            // Count the number of successful completed transaction rows
            $success_count = $result1->num_rows;

            // Display the successful completed transaction count
        ...
        if ($result2) {
            // Count the number of failed transaction rows
            $failed_count = $result2->num_rows;

            // Display the failed transaction count
