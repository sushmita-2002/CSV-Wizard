...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $targetDir = "C:/xampp/htdocs/Training2023/uploads/"; // Replace "uploads" with the folder where you want to store the CSV files.
